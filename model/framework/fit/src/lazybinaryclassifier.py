...
train_file = os.path.join(root, "..","data", "elzahed_efflux_dependent_subset.csv")
model_folder = os.path.join(root, "..", "..", "..", "checkpoints", "efflux")
...
y = train["efflux_dependent_active"].astype(int)
